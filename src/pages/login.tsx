...
export default function LoginPage(){
    ...
    return (
        <Box>
            ...
            <Google onClick = {() => location.href = process.env.NEXT_PUBLIC_LOGIN_GOOGLE!}><Icon/><Name>Google로 시작하기</Name></Google>
            <Kakao onClick = {() => location.href = process.env.NEXT_PUBLIC_LOGIN_KAKAO!}><Icon/><Name>Kakao로 시작하기</Name></Kakao>
            <Naver onClick = {() => location.href = process.env.NEXT_PUBLIC_LOGIN_NAVER!}><Icon/><Name>Naver로 시작하기</Name></Naver>
            </div>
