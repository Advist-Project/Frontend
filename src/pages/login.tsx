...
export default function LoginPage(){
    ...
    return (
        <Box>
            ...
            <Google onClick = {() => location.href = "https://criel.herokuapp.com/user/auth/google"}><Icon/><Name>Google로 시작하기</Name></Google>
            <Kakao onClick = {() => location.href = "https://criel.herokuapp.com/user/auth/kakao"}><Icon/><Name>Kakao로 시작하기</Name></Kakao>
            <Naver onClick = {() => location.href = "https://criel.herokuapp.com/user/auth/naver"}><Icon/><Name>Naver로 시작하기</Name></Naver>
            </div>
