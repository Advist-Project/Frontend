  ...
  return (
    <Layout whiteHeader>
      ...
      <Section3>
        ...
        <Slider {...settings}>
          <div>
            <Coach key="coach1" company="패스트파이브" team="Culture팀 리더" desc="안녕하세요. 저는 패스트파이브의 30번째 멤버로 입사하여 현재는 200명의 구성원의 조직문화와 컬처를 담당하고 있습니다. 커리어를 시작한 4년 동안 전시기획, 영업 직무를 맡았다가 5년차부터 HR로 새 출발을 하고 이제 적응을 마친 것 같습니다. 패스트파이브는 평균연령 31세로 구성된 젊고 빠르게 성장하는 조직으로, 회사와 구성원들이 성장하는 과정에서 겪은 노하우와 경험을 바탕으로 조직문화에 대한 허심탄회한 이야기를 나누고 싶습니다." tag={['HR', '조직문화']}/>
          </div>
          <div>
            <Coach key="coach2" company="크래프톤" team="E-sport 팀" desc="체대를 준비하던 학창 시절부터 스포츠의 가슴 뛰는 설렘을 전달하는 사람이 되고 싶었습니다. 항상 스포츠마케터를 꿈꾸었지만 직무에 대한 구체적인 정보나 아는 사람이 없어 취업, 이직을 하는 과정에서 여러가지 어려움을 겪었습니다. \n커리어 상담을 통해 스포츠 마케팅 분야에서의 커리어를 꿈꾸는 학생/직장인 분들에게 작게나마 도움이 되면 좋겠습니다." tag={['마케터', '스포츠마케팅']}/>
          </div>
          <div>
            <Coach key="coach3" company="삼성전자" team="HRD팀" desc="대기업과 스타트업에서 HR담당자로 근무하며 크고 작은 직원 행사부터 교육 체계, 전사 조직문화 개선 프로젝트까지 여러 HRD 업무를 담당했습니다. \n대기업과 스타트업 사이에서 커리어를 고민하시고 있거나 HRD, 조직문화 분야에서 고민하시는 주니어 실무자 분들에게 도움을 드리고 싶습니다." tag={['HR', '조직문화']}/>
          </div>
          <div>
            <Coach key="coach4" company="모리엔티드" team="마케팅 에이전시 Co-founder" desc="저는 IT 서비스 기업 인하우스 마케터로 일을 시작하였고, 마케팅 관련 강의 기획자를 거쳐 현재는 마케팅 에이전시를 창업하여 운영하고 있습니다. 일이나 커리어에 있어 확실한 정답이 무엇인지는 알 수 없지만, 필요하신 분들에게 제가 겪었던 경험과 시행착오를 공유하고 함께 고민하고 싶습니다." tag={['마케터', '퍼포먼스마케팅']}/>
          </div>
        </Slider>
        </SliderWrap>
      </Section3>
